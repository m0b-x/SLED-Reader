...
The app is composed of two views: 
- **Form View** lets you load files, set filters, and configure plot options.
- **Graph View** displays graphs of raw and filtered acceleration data with optional markers and legends.
